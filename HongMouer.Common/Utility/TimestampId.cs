...
namespace HongMouer.Common.Utility
{
    ...
    /// </summary>
    public class TimestampId : Singleton<TimestampId>
    {
        ...
        static TimestampId()
        {
            //Interlocked.CompareExchange(ref _timestampId, new TimestampId(DateTime.Now), null);
        }
        ...
        protected DateTime InitialDateTime
        {
            get
            {
                return new DateTime(2020, 8, 23, 0, 0, 0, DateTimeKind.Utc);
